      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-start gap-8 lg:gap-[42px]">
        ...
        <div className="flex w-full flex-col items-stretch gap-4 lg:flex-row lg:items-start">
          {PORTFOLIO_FEATURES.map((feature) => (
            <article
              key={feature.title}
              className="flex flex-1 items-start gap-3 rounded-xl border-[1.5px] border-border-primary bg-surface p-6 card-hover hover:-translate-y-1 hover:shadow-lg lg:gap-6 lg:p-8 active:-translate-y-1 active:shadow-lg touch:shadow-lg"
            >
