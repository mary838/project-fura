...
export function PortfolioCard({ image, title, href }: PortfolioCompany) {
  return (
    <Link
      href={href}
      className="group relative flex h-[480px] flex-1 flex-col items-start justify-end overflow-hidden rounded-2xl p-8 shadow-none card-hover hover:z-10 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl active:-translate-y-1 active:scale-[1.02] active:shadow-xl touch:shadow-xl active:z-10"
    >
      <Image
        src={image}
        alt=""
      ...
      */}
      <div className="absolute inset-0 opacity-0 shadow-[inset_0_-140px_110px_-70px_rgba(9,12,20,0.9)] transition-opacity duration-500 group-hover:opacity-100 group-active:opacity-100" />
      ...
      <div className="relative flex w-full flex-col gap-2.5 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-2 group-active:-translate-y-2">
        ...
        <span className="flex items-center gap-1.5">
          ...
          <Image
            ...
            width={24}
            height={24}
            className="size-6 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1 group-active:translate-x-1"
          />
        </span>
      </div>
    </Link>
